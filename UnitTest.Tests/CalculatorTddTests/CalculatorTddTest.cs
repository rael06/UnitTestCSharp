...
namespace UnitTest.Tests.CalculatorTddTests
{
    public class CalculatorTddTest
    {
        ...
        [InlineData(2, 4, 8)]
        [InlineData(2, 0, 0)]
        public void Should_Return_Correct_Result_When_Multiply_The_Given_2_Numbers(int number1, int number2, int expected)
        {
            // Arrange
        ...
        [InlineData(6, 4, 1.5)]
        [InlineData(0, 4, 0)]
        public void Should_Return_Correct_Result_When_Divide_The_Given_2_Numbers(int number1, int number2, double expected)
        {
            // Arrange
            var calculatorTdd = new CalculatorTdd(number1, number2);
